...
export namespace Prisma {
  ...
  */
    ...
    model: {
      UserContact: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.UserContactFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.UserContactAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserContactOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "fullname" | "email" | "typemessage" | "message" | "createdAt" | "updatedAt", ExtArgs["result"]["userContact"]>
  ...
  export interface UserContactDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more UserContacts that matches the filter.
     * @param {UserContactFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const userContact = await prisma.userContact.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: UserContactFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a UserContact.
     * @param {UserContactAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const userContact = await prisma.userContact.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: UserContactAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface UserContactFieldRefs {
    ...
    readonly fullname: FieldRef<"UserContact", 'String'>
    readonly email: FieldRef<"UserContact", 'String'>
    readonly typemessage: FieldRef<"UserContact", 'String'>
    readonly message: FieldRef<"UserContact", 'String'>
   ...
   * UserContact findRaw
   */
  export type UserContactFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * UserContact aggregateRaw
   */
  export type UserContactAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type UserContactWhereInput = {
    ...
    fullname?: StringFilter<"UserContact"> | string
    email?: StringFilter<"UserContact"> | string
    typemessage?: StringFilter<"UserContact"> | string
    message?: StringNullableFilter<"UserContact"> | string | null
  ...
  export type UserContactScalarWhereWithAggregatesInput = {
    ...
    fullname?: StringWithAggregatesFilter<"UserContact"> | string
    email?: StringWithAggregatesFilter<"UserContact"> | string
    typemessage?: StringWithAggregatesFilter<"UserContact"> | string
    message?: StringNullableWithAggregatesFilter<"UserContact"> | string | null
  ...
  export type UserContactUpdateInput = {
    ...
    typemessage?: StringFieldUpdateOperationsInput | string
