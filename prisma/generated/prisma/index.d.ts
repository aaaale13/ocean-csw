...
export namespace Prisma {
  ...
  */
      ...
      UserContact: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<UserContactCountAggregateOutputType>
              | number;
          };
        };
      };
    ...
    Prisma.PrismaPromise<
      Array<
        PickEnumerable<UserContactGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof UserContactGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  type UserContactGetPayload<
    S extends boolean | null | undefined | UserContactDefaultArgs,
  > = $Result.GetResult<Prisma.$UserContactPayload, S>;

  type UserContactCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
  ...
  > {
     ...
     */
    aggregateRaw(
      args?: UserContactAggregateRawArgs,
    ...
    aggregate<T extends UserContactAggregateArgs>(
      args: Subset<T, UserContactAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, UserContactGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
  ...
  > = {
    ...
    data: XOR<
      ...
      UserContactUncheckedUpdateManyInput
    >;
    /**
   ...
   * UserContact findRaw
   */
  export type UserContactFindRawArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   */
  export type UserContactAggregateRawArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
